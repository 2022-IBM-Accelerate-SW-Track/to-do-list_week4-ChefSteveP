...
class AddTodo extends Component {
  ...
  handleSubmit = (event) => {
    ...
    const jsonObject = {
      id: this.state.id,
      task: this.state.content,//value representing the task content>,
      currentDate: this.state.date,//<value representing the date/time task was added>,
      dueDate: this.state.duedate, //<value representing the date/time task is due>
   };
    Axios({
     method: "POST",
